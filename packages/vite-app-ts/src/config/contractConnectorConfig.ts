...
export const contractConnectorConfig = () => {
  try {
    const result = {
      ...
      SoulBoundNFTFactory: createConnectorForHardhatContract(
        'SoulBoundNFTFactory',
        hardhatContracts.SoulBoundNFTFactory__factory,
        hardhatContractsJson
      ),

      SoulBoundNFTProxyRegistry: createConnectorForHardhatContract(
        'SoulBoundNFTProxyRegistry',
        hardhatContracts.SoulBoundNFTProxyRegistry__factory,
        hardhatContractsJson
      ),
